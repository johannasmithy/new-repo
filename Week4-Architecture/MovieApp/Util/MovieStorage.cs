class MovieStorage
{
    ...
    */
    ...
    public MovieStorage()
    {
        Movie movie1 = new(idCounter++, "Iron Ham", 5.5, true, 0); //this is a pre-increment- will use the value first, then add 1
        Movie movie2 = new(idCounter, "Bravefart", 5.5, true, 0); idCounter++; //this is a post-increment - the existing id is set, then one is added outside
        Movie movie3 = new(idCounter++, "Top Fun", 5.5, true, 0);
